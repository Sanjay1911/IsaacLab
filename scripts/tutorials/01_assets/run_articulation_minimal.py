...
def design_scene() -> tuple[dict, list[list[float]]]:
    ...
    origins = [[0.50, 0.50, 0.50], [-1.0, 0.0, 0.50]]
    # Origin 1
    ...
    ur5_cfg.prim_path = "/World/Origin.*/Robot"
    ur5 = Articulation(cfg=ur5_cfg)

    # return the scene information
    scene_entities = {"ur5": ur5}
